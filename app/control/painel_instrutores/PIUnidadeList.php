<?php
/**
* Classe que representa a listagem de Unidade.
* PIUnidadeList Listing
*
* @version    1.0
...
* @since      24/11/2023
**/
class PIUnidadeList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_PIUnidade');
        $this->form->setFormTitle('<i class="fas fa-chess-rook fa-fw"></i> Unidade Operacional');        
        ...
        $this->form->addActionLink(_t('New'), new TAction(['PIUnidadeForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['PIUnidadeForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onInlineEdit($param)
    {
        try
        {
            ...
            $object = new PIUnidade($key); // instantiates the Active Record
            $object->{$field} = $value;
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for PIUnidade
            $repository = new TRepository('PIUnidade');
            $limit = 10;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            TTransaction::open('db_painel_instrutores'); // open a transaction with database
            $object = new PIUnidade($key, FALSE); // instantiates the Active Record
