<?php
/**
* Classe que representa o formulário de cadastro de Unidade.
* PIUnidadeForm Registration
*
* @version    1.0
...
* @since      24/11/2023
**/
class PIUnidadeForm extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_PIUnidade');
        ...
        $this->form->addActionLink(_t('Back'), new TAction( ['PIUnidadeList', 'onReload']), 'fa:undo');
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new PIUnidade;  // create an empty object
