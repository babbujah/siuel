<?php
/**
* Classe que representa o formulário de cadastro de Área.
* PIAreaForm Registration
*
* @version    1.0
...
* @since      24/11/2023
**/
class PIAreaForm extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_PIArea');
        $this->form->setFormTitle('Cadastro de Área');        
        ...
        $this->form->addActionLink(_t('Back'), new TAction(['PIAreaList', 'onReload']), 'fa:undo');
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new PIArea;  // create an empty object
