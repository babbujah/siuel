<?php
/**
* Classe que representa o formulário de cadastro de uma equipe.
* EquipeForm Registration
*
* @version    1.0
...
class EquipeForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle('Matilha/Patrulha/Equipe');
        ...
        $this->form->addActionLink(_t('Back'),  new TAction(['EquipeList', 'onReload']), 'fa:undo');
