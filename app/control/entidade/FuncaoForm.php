<?php
/**
* Classe que representa o formulário de cadastro de uma função.
* FuncaoForm Registration
*
* @version    1.0
...
* @since      25/01/2024
**/
class FuncaoForm extends TPage
{
    protected $form; // form
    ...
    public function onSave( $param )
    {
        try
        {
            TTransaction::open('siuel'); // open a transaction
            ...
            **/
            ...
            $object = new Funcao;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                TTransaction::open('siuel'); // open a transaction
                $object = new Funcao($key); // instantiates the Active Record
